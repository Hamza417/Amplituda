...
Java_com_linc_amplituda_Amplituda_amplitudesFromAudioJNI(
        JNIEnv* env,
        jobject,
        jstring jaudio_path,
        jint jcompress_type,
    ...
    if(jlistener != NULL) {
        jclass listener_class = env->FindClass("com/linc/amplituda/AmplitudaProgressListener");
    ...
    jclass amplitudaResultClass = (env)->FindClass("com/linc/amplituda/AmplitudaResultJNI");
